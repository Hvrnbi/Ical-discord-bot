...
def tomorrow():
    ...
    for event in cal.events:
        if event.get("DTSTART").dt.day - 1 == today.day and event.get("DTSTART").dt.month == today.month :        # Check every event in the calendar and execute the code if their are today
            event_desc = "\n"+"### "+event.get("SUMMARY")+" ###"
